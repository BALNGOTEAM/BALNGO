...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BALNGO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BA", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S BALNGO -X kill
screen -S BALNGO ./BALNGO
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BALNGOTEAM/Files_BALNGO/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1065793683,1033028167}   
...
if tonumber(user_id) == tonumber(1065793683) then  
var = true  
...
local BALNGO_Msg = ''  
if msgs < 100 then 
BALNGO_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BALNGO_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BALNGO_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BALNGO_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BALNGO_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BALNGO_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BALNGO_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BALNGO_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BALNGO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BALNGO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BALNGO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BALNGO_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
BALNGO_Msg = 'رب التفاعل'  
end 
return BALNGO_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBALNGO(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,BALNGO_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf BALNGO.lua')
os.execute('wget https://raw.githubusercontent.com/BALNGOTEAM/BALNGO/main/BALNGO.lua')
send(msg.chat_id_, msg.id_,' ☬⇠ تم تحديث السورس \n ☬⇠ لديك اخر اصدار لسورس بلنكو\n ☬⇠ الاصدار » { 1.3v}')
dofile('BALNGO.lua')  
end
if text == 'الاصدار ☬' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☬⇠ اصدار سورس بلنكو \n ☬⇠ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'☬⇠  عدد الكروبات الان » { '..#group..' }'..BALNGOk..''..BALNGO..'\n☬⇠  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ☬⇠ العضو » ['..result.title_..'](t.me/'..(username or '@auadd')..')'
status  = '\n ☬⇠ تم ترقيته مطور'
...
usertext = '\n ☬⇠ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or '@auadd')..')'
status  = '\n ☬⇠ تم ترقيته مطور'
...
local BALNGO1_Msg = database:get(bot_id.."BALNGO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BALNGO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☬⇠ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or '@auadd')..') \n ☬⇠ '..BALNGO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if BALNGO_Msg and not Special(msg) then  
local BALNGO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BALNGO_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☬⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☬⇠ ["..BALNGO_Msg.."] \n")
else
send(msg.chat_id_,0," ☬⇠ العضو : {["..data.first_name_.."](T.ME/@auadd)}\n ☬⇠ ["..BALNGO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☬⇠ عذرا » {["..data.first_name_.."](T.ME/@auadd)}\n ☬⇠ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━𝐁𝐀━━━━━━≫
 ☬⇠ ↬𝐁𝐀𝐋𝐍𝐆𝐎 𝐓𝐄𝐀𝐌
≪━━━━━━𝐁𝐀━━━━━━≫
 ☬⇠ ↬[Channel BALNGO](t.me/@auadd) 
≪━━━━━━𝐁𝐀━━━━━━≫
 ☬⇠ ↬[Information](t.me/@auadd)
≪━━━━━━𝐁𝐀━━━━━━≫
 ☬⇠ ↬[DEVELOPER](t.me/rrr6rrr)
≪━━━━━━𝐁𝐀━━━━━━≫
 ☬⇠ ↬[The way his inauguration](https://t.me/@auadd/365)
≪━━━━━━𝐁𝐀━━━━━━≫
 ☬⇠ ↬[To talk to us](http://t.me/@auadd)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☬⇠ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or '@auadd')..') \n ☬⇠ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☬⇠ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or '@auadd')..') \n ☬⇠ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☬⇠ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or '@auadd')..')'
status  = '\n ☬⇠ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☬⇠ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☬⇠ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or '@auadd')..')'
...
database:set(bot_id.."BALNGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BALNGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ☬⇠ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BALNGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BALNGO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BALNGO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BALNGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ☬⇠ تم منع الكلمه مع التحذير")  
database:del(bot_id.."BALNGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BALNGO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BALNGO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BALNGO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ☬⇠ ارسل الكلمه الان")  
database:set(bot_id.."BALNGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BALNGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BALNGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BALNGO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BALNGO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BALNGO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BALNGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BALNGO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BALNGO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ☬⇠ قائمة المنع \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do  
local BALNGO_Msg = database:get(bot_id.."BALNGO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BALNGO_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☬⇠ العضو » ['..result.title_..'](t.me/'..(text1[3] or '@auadd')..')'..'\n ☬⇠ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بلنكو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بلنكو')
local BALNGO_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..BALNGO_Msg[math.random(#BALNGO_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بلنكو').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or '@auadd')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
BALNGOdx(msg.chat_id_, msg.id_, ' ☬⇠ ايدي المجموعة » ( '..msg.chat_id_..' )\n ☬⇠ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ☬⇠ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ☬⇠ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'ٴ☬⇠ٴ≪━━━━━━𝐁𝐀━━━━━━≫ٴ☬⇠○ٴ\n☬⇠ 彡 .[G𝐇𝐎𝐒𝐓 𝐁𝐀𝐋𝐍𝐆𝐎](t.me/@auadd)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بلنكو')
...
BALNGO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BALNGO)
...
--------------------------------------------------------------------------------------------------------------
SourceBALNGO(data.message_,data)
...
------------------------------------------------------------------------
local BALNGOAbot = database:get(bot_id.."BALNGO1:Add:Filter:Rp2"..text..result.chat_id_)   
if BALNGOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☬⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☬⇠ ["..BALNGOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local BALNGO1_Msg = database:get(bot_id.."BALNGO1:Add:Filter:Rp2"..text..result.chat_id_)   
if BALNGO1_Msg then    
send(msg.chat_id_, msg.id_," ☬⇠ "..BALNGO1_Msg)
